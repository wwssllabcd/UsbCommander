...
BEGIN_MESSAGE_MAP(CUsbCommanderApp, CWinApp)
...
CUsbCommanderApp::CUsbCommanderApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CUsbCommanderApp 物件

CUsbCommanderApp theApp;


// CUsbCommanderApp 初始設定

BOOL CUsbCommanderApp::InitInstance()
{
